...
## Approved design: implement this (Brian, 2026-09-26)

**This section is the implementation spec.** It folds Brian's review decisions into §1–§10 and "Changes after comparison" (M1–M4). Where it disagrees with earlier text, this section wins. Earlier sections stay as the record of how the design was reached. Read §3, §4, and §7 for the details this section doesn't repeat.
