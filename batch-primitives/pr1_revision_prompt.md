...
Status: done. Final head `fbf43fb` (2026-09-26), rebased on upstream `68db683`, after follow-ups at Brian's request: typo, comment wording, README paragraph removed, docstrings trimmed, validation and Lease/retry helpers moved to `batch_utils.py`, unused `BatchState` code moved to PR 2, RBAC trimmed, `backoff_delay` rewritten.
